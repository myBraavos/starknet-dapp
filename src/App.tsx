...
function Call({ network = "goerli-alpha" }: { network?: string }) {
    ...
    const token_address =
        "0x51c73f8c424c346c1fb3e050fd4e05c2c98644e347928d685c6f0301673c58a";
...
function Invoke({ network = "goerli-alpha" }: { network?: string }) {
    const mint = async () => {
        ...
        if (wallet.isConnected) {
            const contractAddress = "0x51c73f8c424c346c1fb3e050fd4e05c2c98644e347928d685c6f0301673c58a";
            if (!contractAddress) {
                return undefined;
            }
